...
@section('content')
    ...
    <div class="card shadow mb-4">
        <div class="card-body">
            <p>Selamat Datang, <strong>{{ Auth::user()->name }}</strong>. Silakan pilih motor yang tersedia di bawah ini.
            </p>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="mt-2 text-gray-600 small">Harga: Rp {{ number_format($motor->harga_sewa) }}/hari
                                </div>
                            </div>
                            <div class="col-auto">
                        ...
                        <form action="{{ route('rental.pinjam') }}" method="POST" class="mt-3">
                            ...
                            <div class="form-group mb-2">
                                <label class="small font-weight-bold">Mulai Sewa:</label>
                                <input type="date" name="tgl_pinjam" class="form-control form-control-sm"
