            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $totalMotor }}</div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">{{ $totalSewa }}</div>
                    </div>
                    <div class="col-auto">
...
<div class="row">
    <div class="col-lg-12">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <p>Gunakan menu di samping kiri untuk mengelola data inventaris motor, data anggota, dan melihat laporan transaksi secara real-time.</p>
            </div>
        </div>
    </div>
</div>
